    ...
    <div class="content">
        <svg
            ...
            <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110">
                ...
                <text aria-hidden="true" x="915" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="210">{{ $dayVisits }}</text>
                <text x="915" y="140" transform="scale(.1)" fill="#fff" textLength="210">{{ $dayVisits }}</text>
            </g>
        </svg>
    </div>
</div>
